...
public final class FragmentAudioBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView audioDataRv;

  private FragmentAudioBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView audioDataRv) {
    this.rootView = rootView;
    this.audioDataRv = audioDataRv;
  }
  ...
  public static FragmentAudioBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.audio_data_rv;
      RecyclerView audioDataRv = ViewBindings.findChildViewById(rootView, id);
      if (audioDataRv == null) {
        break missingId;
      }

      return new FragmentAudioBinding((ConstraintLayout) rootView, audioDataRv);
    }
